      ...
      <div className="flex flex-col">
        ...
        <div className="px-[16px] mb-4">
          {user.bank_details.account_type2 == 'saving_account' ? (
            <div className="flex flex-col justify-between gap-4 bg-[#223e99] text-white p-4 rounded-lg">
              ...
              <div className="flex justify-between gap-6">
                ...
                <div className="flex flex-col gap-5">
                  <Link href="/dashboard/transfer" className="p-[5px_20px] flex rounded-full bg-white text-[#223e99] text-[14px]">
                    Transfer
                  </Link>
                </div>
              </div>
            ...
            <div className="border flex flex-col gap-6 bg-[#223e99] text-white p-4 rounded-lg">
              ...
              <div className="flex items-center justify-between">
                ...
                <Link href="/dashboard/transfer" className="p-[5px_20px] rounded-full bg-white text-[#223e99] text-[14px]">
                  Send money
                </Link>
              </div>
            </div>
        ...
        <div className="p-[16px] hidden border py-8">
          <div className="flex items-center justify-center gap-3">
            <Link href="/dashboard/cards" className="border flex items-center gap-1 p-4 py-2 text-[13px] max-w-max bg-white text-[#223e99] rounded-full">
              <CardIcon className="w-5 h-5" /> <span>Cards</span>
            </Link>
            <Link href="/dashboard/bill-payment" className="border flex items-center gap-1 p-4 py-2 text-[13px] max-w-max bg-white text-[#223e99] rounded-full">
        ...
        <div className="border flex flex-col gap-4 p-6 px-4">
          <div className="border flex flex-col gap-4 bg-white overflow-hidden">
            <div className="w-full h-56 overflow-hidden">
              <Image src="https://i.postimg.cc/44hz19CL/greenpath_financial_wellness_1760730362.jpg" width={5000} height={5000} className="" alt="sjsusbnnsn" />
            </div>

            <div className="text-center text-black p-3 px-7 pb-7">
              <p>Financial Wellness</p>
              <p>The Greenpath Difference</p>
            </div>
          </div>
          <div className="border flex flex-col gap-4 bg-white overflow-hidden">
            <div className="w-full h-56 overflow-hidden">
              <Image src="https://i.postimg.cc/fW0xv947/insurance_options_1760730362.jpg" width={5000} height={5000} className="" alt="sjsusbnnsn" />
            </div>

            <div className="text-center text-black p-3 px-7 pb-7">
              <p>Insurance Options</p>
              <p>Low-cost insurance options to help safeguard what matters most.</p>
            </div>
          </div>
        </div>
      </div>
